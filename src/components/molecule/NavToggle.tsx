...
function NavToggle(props: NavToggleProps) {
  ...
  return (
    <div className="relative w-fit mt-1 flex gap-1 glass-blur px-1 py-1 rounded-full">
      ...
      <div className={`absolute top-1 left-1 w-24 h-10 bg-white/10 rounded-full transition-transform ease-in-out duration-500 ${activeState === 'about' ? 'translate-x-[100px]' : 'translate-x-0'}`} />
      <div 
