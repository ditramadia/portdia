...
function NavToggle(props: NavToggleProps) {
  ...
  return (
    <div className="relative w-fit mt-1 flex gap-1 glass-blur px-2 py-2 rounded-full">
      <div className={`absolute -top-1 left-9 w-8 h-1 bg-white rounded-full transition-transform ease-in-out duration-500 ${activeState === 'about' ? 'translate-x-[105px]' : 'translate-x-0'}`}>
